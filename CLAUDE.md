...
@AGENTS.md
- Penlo landing page: Next.js 16 + Tailwind v4. Marketing site for the Penlo iPad app.
- Dev server: npm run dev -> http://localhost:4321 (port 4321, not 3000).
- Next.js 16 differs from training data: read the relevant guide in node_modules/next/dist/docs/ before writing framework-touching code; heed deprecation notices.
